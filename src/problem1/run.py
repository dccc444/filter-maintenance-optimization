...
def save_outputs(results: AnalysisResults, output_dir: Path) -> None:
    ...
    table_map: dict[str, pd.DataFrame] = {
        ...
        "maintenance_effect_duration.csv": results.maintenance_duration,
        "maintenance_effect_duration_summary.csv": results.maintenance_duration_summary,
        "maintenance_effect_survival.csv": results.maintenance_duration_survival,
        "maintenance_slope_change.csv": results.maintenance_slope_change,
        "maintenance_slope_change_summary.csv": results.maintenance_slope_change_summary,
